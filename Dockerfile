...
# RUN cargo install uniffi-bindgen-cs --tag v0.11.0+v0.30.0 --git https://github.com/NordSecurity/uniffi-bindgen-cs
# RUN cargo install uniffi-bindgen-go --tag v0.5.0+v0.30.0 --git https://github.com/NordSecurity/uniffi-bindgen-go
# RUN cargo install uniffi-bindgen-cpp --tag v0.8.0+v0.30.0 --git https://github.com/NordSecurity/uniffi-bindgen-cpp
